...
- **Fonts and typography:** Fraunces preserves the concept's high-contrast warm
  editorial display voice; Inter supports readable body copy; JetBrains Mono owns
  compact facts. Weight, line height, wrap, and optical hierarchy match at desktop
...
- **Responsiveness:** no document-level horizontal overflow at 320, 390, 768, or
  1440 CSS pixels. The first mobile viewport contains the price and primary CTA.
...
- The mobile purchase bar appears after the hero and hides at the closing CTA or
...
- [x] 320, 390, 768, and 1440 responsive checks completed
